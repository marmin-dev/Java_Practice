...
public class ConsumerAndThenEx {
	...
	public static void main(String[] args) {
		...
		//Consumer<T>함수적 인터페이스는 매개값p를 받아와서 단순히 소비하는 역할만 한다
		...
		//위에 정의된 2개의 함수적 인터페이스 ConsumerA와 ConsumerB를 가지고 아래와 같이 코딩을 하면,
		//컨슈머 A가 먼저 실행되고, 이어서 consumerB가 실행되어 출력결과가 나온다
		Consumer<People> consumerAB = consumerA.andThen(consumerB);
		consumerAB.accept(new People("장개방", "Jang", null));
